  ...
  argocd = {
    ...
    values = [
      templatefile("${path.root}/values/argocd.yaml.tftpl", {
        url_gitops_argocd           = "gitops.654654545585.realhandsonlabs.net"
        aws_acm_arn                 = "arn:aws:acm:us-east-1:654654545585:certificate/d97e8a15-f710-45a3-937a-bfdd34f929bd"
