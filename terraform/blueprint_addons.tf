  ...
  argocd = {
    ...
    values = [
      templatefile("${path.root}/values/argocd.yaml.tftpl", {
        url_gitops_argocd           = "gitops.443526375523.realhandsonlabs.net"
        aws_acm_arn                 = "arn:aws:acm:us-east-1:443526375523:certificate/588263f8-ef8a-403c-9985-dd0a5cb8a995"
