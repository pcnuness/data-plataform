  ...
  argocd = {
    ...
    values = [
      templatefile("${path.root}/values/argocd.yaml.tftpl", {
        url_gitops_argocd           = "gitops.079910998645.realhandsonlabs.net"
        aws_acm_arn                 = "arn:aws:acm:us-east-1:079910998645:certificate/6851a041-44d2-4257-9935-fbb6b904afd4"
