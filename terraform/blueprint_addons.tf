  ...
  argocd = {
    ...
    values = [
      templatefile("${path.root}/values/argocd.yaml.tftpl", {
        url_gitops_argocd           = "gitops.694137446771.realhandsonlabs.net"
        aws_acm_arn                 = "arn:aws:acm:us-east-1:694137446771:certificate/a95c06ac-bf27-4d6f-ae38-aff3296302fe"
