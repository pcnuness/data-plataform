  ...
  argocd = {
    ...
    values = [
      templatefile("${path.root}/values/argocd.yaml.tftpl", {
        url_gitops_argocd           = "gitops.730335365460.realhandsonlabs.net"
        aws_acm_arn                 = "arn:aws:acm:us-east-1:730335365460:certificate/0a823b72-513b-4f31-8add-b626c1eddb4a"
