  ...
  argocd = {
    ...
    values = [
      templatefile("${path.root}/values/argocd.yaml.tftpl", {
        url_gitops_argocd           = "gitops.975049901454.realhandsonlabs.net"
        aws_acm_arn                 = "arn:aws:acm:us-east-1:975049901454:certificate/2337b70d-9bc9-4bdf-afaa-21e421276d60"
